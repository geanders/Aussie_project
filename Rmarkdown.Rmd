...
```{r initial data cleanup, include=FALSE, echo=FALSE}
...
#
# the final clean dataset herre is geo_aussie_data
```
...
```{r smallmap,fig.align='center', echo=FALSE, fig.width=4, dpi=600}
...
map_small <- ggmap(northern_terr_zoomed, extent = "device") +
  geom_point(data = temp_data, aes(x = Longitude, y = Latitude, 
             color = sample_type), size = .5, position = "jitter")+
  geom_point(data = ranger_location, aes(x = long, y = lat), 
             size = 1.5, color = "green") +
